package net.mcreator.mymod.client.model;
...
public class Modeldemiyrg<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("mymod", "modeldemiyrg"), "main");
	public final ModelPart Hed;
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Hed = partdefinition.addOrReplaceChild("Hed",
				CubeListBuilder.create().texOffs(0, 0).addBox(-4.6599F, -6.2F, -5.2909F, 10.0F, 10.0F, 10.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-1.3F, -12.8F, 2.3F, 0.0F, 0.0175F, 0.0F));
		PartDefinition cube_r1 = Hed.addOrReplaceChild("cube_r1",
				CubeListBuilder.create().texOffs(36, 2).addBox(-6.4F, -39.25F, 3.25F, 1.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(30, 0)
		...
		PartDefinition cube_r2 = Hed.addOrReplaceChild("cube_r2",
				CubeListBuilder.create().texOffs(0, 0).addBox(3.3F, -39.65F, 7.25F, 1.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(26, 20)
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body",
				CubeListBuilder.create().texOffs(0, 20).addBox(-5.0F, -11.2F, -1.0F, 10.0F, 18.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-1.0F, 2.2F, 0.0F));
		PartDefinition cube_r3 = body.addOrReplaceChild("cube_r3",
				CubeListBuilder.create().texOffs(56, 33).addBox(4.75F, -18.25F, 19.0F, 4.0F, 4.0F, 6.0F, new CubeDeformation(0.0F)).texOffs(40, 0)
		...
		PartDefinition cube_r4 = body.addOrReplaceChild("cube_r4",
				CubeListBuilder.create().texOffs(50, 11).addBox(0.0F, -17.25F, 5.25F, 4.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.0F, 21.8F, 0.0F, -0.4215F, -0.3614F, 0.1572F));
		PartDefinition cube_r5 = body.addOrReplaceChild("cube_r5",
				CubeListBuilder.create().texOffs(56, 22).addBox(-2.5F, -17.5F, -1.75F, 4.0F, 3.0F, 8.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition LeftHand = partdefinition.addOrReplaceChild("LeftHand",
				CubeListBuilder.create().texOffs(0, 44).addBox(-3.0F, -2.9F, -4.0F, 6.0F, 18.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(7.0F, -6.0F, 3.0F));
		PartDefinition RightHand = partdefinition.addOrReplaceChild("RightHand",
				CubeListBuilder.create().texOffs(32, 20).addBox(-2.75F, -2.4F, -3.0F, 6.0F, 18.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-9.25F, -6.5F, 2.0F));
		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg",
				CubeListBuilder.create().texOffs(24, 44).addBox(-1.0F, -15.0F, -1.0F, 5.0F, 15.0F, 6.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 24.0F, 0.0F));
		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg",
				CubeListBuilder.create().texOffs(46, 44).addBox(-2.0F, -1.0F, -1.0F, 5.0F, 15.0F, 6.0F, new CubeDeformation(0.0F)),
