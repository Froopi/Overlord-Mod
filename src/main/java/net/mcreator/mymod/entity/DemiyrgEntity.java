...
package net.mcreator.mymod.entity;
...
import net.mcreator.mymod.init.MymodModEntities;

public class DemiyrgEntity extends Monster {
	private final ServerBossEvent bossInfo = new ServerBossEvent(this.getDisplayName(), ServerBossEvent.BossBarColor.RED,
			ServerBossEvent.BossBarOverlay.PROGRESS);

	public DemiyrgEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(MymodModEntities.DEMIYRG.get(), world);
	}

	public DemiyrgEntity(EntityType<DemiyrgEntity> type, Level world) {
		super(type, world);
		xpReward = 50;
		setNoAi(false);
